<?php
//wp-content\plugins\bdthemes-element-pack-lite\modules\slider\widgets\slider.php
...
?>
	...
	?>
		<div class="swiper-wrapper">
			<?php $counter = 1; ?>
			<?php foreach ($settings['tabs'] as $key=>$item) : ?>				<?php
				...
				<div <?php echo $this->get_render_attribute_string('slide-item'); ?>>
					...
					?>
						...
						<!-- новая вставка названий заголовкой-->
						<div class="bdt-slide-title-botom-nav">
						<?php if (('' !== $item['tab_title']) && ($settings['show_title'])) : ?>
							<?php
									if (isset($settings["tabs"][0]["tab_title"])):								
									
									  
									?>
										<h6 class="bdt-slide-title-botom <?php echo $key==0 ? 'select-titbtm' : ''; ?>">
									      <?php echo wp_kses_post($settings["tabs"][0]["tab_title"]); ?>
									    </h6>
									<?php endif; ?> 	
									<?php
									if (isset($settings["tabs"][1]["tab_title"])) : ?>
										<h6 class="bdt-slide-title-botom <?php echo $key==1 ? 'select-titbtm' : ''; ?>">
									       <?php echo wp_kses_post($settings["tabs"][1]["tab_title"]); ?>
									    </h6>
									<?php endif; ?> 	<?php
									if (isset($settings["tabs"][2]["tab_title"])) : ?>
										<h6 class="bdt-slide-title-botom <?php echo $key==2 ? 'select-titbtm' : ''; ?>">
									<?php echo wp_kses_post($settings["tabs"][2]["tab_title"]); ?>
									</h6>
									<?php endif; ?> 
								
									<?php
									if (isset($settings["tabs"][3]["tab_title"])) : ?>
										<h6 class="bdt-slide-title-botom <?php echo $key==3 ? 'select-titbtm' : ''; ?>">
									<?php echo wp_kses_post($settings["tabs"][3]["tab_title"]); ?>
									</h6>
									<?php endif; ?> 


													<!-- echo var_dump($settings["tabs"][0]["tab_title"]);
echo var_dump($settings["tabs"][1]["tab_title"]);
echo var_dump($settings["tabs"][2]["tab_title"]); -->
							<?php endif; ?>
							<!-- / -->
						</div>
					<?php
