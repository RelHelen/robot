<?php
// создание произвольных мета box
 ...
 *https://wp-kama.ru/id_6732/kama_post_meta_box.html
...
// настраиваем поля, которые нужны
class_exists('Kama_Post_Meta_Box') && new Kama_Post_Meta_Box(
	array(
		'id'         => 'my',
		'title'      => 'Данные используются для SEO',
        //для постов
        'post_type'  => array('post'),
        'disable_func' => function($post){
            //видна только в этой рубрике
           // if( ! in_category('dron', $post) ) return 'отключить';
        },
		'theme' => array(
		...
		'fields'     => array(
            ...
            //     'type'=>'text', 
			// 	   'title' => 'Заголовок',
            //     'desc'=>'Будет добавлен поверх картинки'
			// ),		
			...
			// 	//'type'=>'wp_editor',
            //     'type'=>'image',                
            //     'title'=>'Поле для добавление фотографии в промо блоке на странице ',
            //     'desc'  => 'фотография ичпользуется в промо блоке на странице',                
            //     // 'options'=>array(
            //     //     'tinymce'=>1,                    
            //     //     'media_buttons' => true,) 
            //         // список настроек: http://wp-kama.ru/function/wp_editor
			// ),
          
            'keywords'    =>  array(
                'type'  => 'text',
                'title' => 'Keywords',
                'desc'  => 'Ключевые слова страницы',
                'attr'  => 'style="width:99%;"',
            ),
            'description'    =>  array(
                'type'  => 'textarea',
            ...
            // 'image_footer' => array(               
			// 	'type'=>'image', 
            //     'title'=>'Фотография для меню в подвале',
            //     'desc'  => 'фотография иcпользуется для меню в подвале',
